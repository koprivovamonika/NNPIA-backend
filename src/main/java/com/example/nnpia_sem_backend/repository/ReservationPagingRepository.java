...
public interface ReservationPagingRepository extends PagingAndSortingRepository<Reservation, Long> {
    ...
    Page<Reservation> findAllByBeautySalon_IdAndReservationDateAndStatusIsNot(Long salonId, Date reservationDate, Pageable pageVariable, ReservationStatus status);
}
